...
describe('Testing Checkout page components', () => {
    let cart;
    let loadCart;
    let paymentSummary;
    let deliveryOptions;
    ...
    it('diplays the page correctly', async () => {
        ...
        const paymentSummary = await screen.findByTestId('product-cost')
        ...
        /*Check the order summary is overall correct since
       OrderSummary is tested in more detail in OrderSummary.test.jsx */
        ...
        */
        ...
        expect(screen.getByTestId('product-cost')).toHaveTextContent('Items (3):')
